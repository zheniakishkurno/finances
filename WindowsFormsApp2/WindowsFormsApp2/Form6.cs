...
namespace WindowsFormsApp2
{
    public partial class Form6 : Form
    {
        ...
        private void Form6_Resize(object sender, EventArgs e)
        {
            ...
            // Установка размеров кнопки guna2Button1 пропорционально изменению размеров формы
            guna2Button5.Width = (int)(this.Width * 0.2); // Например, кнопка будет занимать 20% ширины формы
            guna2Button5.Height = (int)(this.Height * 0.1); // Например, кнопка будет занимать 10% высоты формы
        ...
        private void CenterButtons()
        {
            ...
            guna2Button5.Location = new Point(buttonX, buttonY + 2 * (buttonHeight + spacing));
