...
namespace WindowsFormsApp2
{
    public partial class Form18 : Form
    {
        ...
        public Form18(int background, int plauplay, string username)
        {
            InitializeComponent();

            // Связываем textBox1 с ToolTip и устанавливаем описание "Введите имя"
            toolTip1.SetToolTip(guna2TextBox1, "сумму за выбранный период");
        ...
        private void Form18_Resize(object sender, EventArgs e)
        {
            ...
            // Рассчитываем размеры и положение для элементов
            ...
            int textBoxSpacing = 10; // Расстояние между элементами
            ...
            // Позиционирование dateTimePicker2 под dateTimePicker1
            dateTimePicker2.Width = textBoxWidth;
            dateTimePicker2.Height = textBoxHeight;
            dateTimePicker2.Anchor = AnchorStyles.Top | AnchorStyles.Right;
            dateTimePicker2.Location = new Point(this.ClientSize.Width - textBoxWidth - rightMargin, dateTimePicker1.Bottom + textBoxSpacing);

            // Позиционирование guna2TextBox1 под dateTimePicker2
            ...
            guna2TextBox1.Location = new Point(this.ClientSize.Width - textBoxWidth - rightMargin, dateTimePicker2.Bottom + textBoxSpacing);
        ...
        private void SaveToDatabase(string Username)
        {
            ...
            if (!string.IsNullOrWhiteSpace(guna2TextBox1.Text))
            {
                using (ExcelPackage package = new ExcelPackage(newFile))
                {
                    ...
                    string firstSheetName =  "сумму за выбранный период";
                    ...
                    if (worksheet == null)
                    {
                        ...
                        // Добавляем подписи для dateTimePicker1 и dateTimePicker2
                    ...
                    {
                        // Если лист существует, то найдем первую пустую строку и запишем данные туда
                        ...
                        worksheet.Cells[nextRow, 3].Value = dateTimePicker1.Value.ToString("dd/MM/yyyy");

                        // Сохраняем данные из dateTimePicker2
                        worksheet.Cells[nextRow, 4].Value = dateTimePicker2.Value.ToString("dd/MM/yyyy");
                    }
