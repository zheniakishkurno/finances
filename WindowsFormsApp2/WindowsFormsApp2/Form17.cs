...
namespace WindowsFormsApp2
{
    public partial class Form17 : Form
    {
        ...
        public Form17(int background, int plauplay, string username)
        {
            InitializeComponent();

            // Связываем textBox1 с ToolTip и устанавливаем описание "Введите имя"
            toolTip1.SetToolTip(guna2TextBox1, "среднее за выбранный период");
        ...
        private void SaveToDatabase(string Username)
        {
            ...
            if (!string.IsNullOrWhiteSpace(guna2TextBox1.Text))
            {
                using (ExcelPackage package = new ExcelPackage(newFile))
                {
                    ...
                    string sheetName = "среднее за выбранный_период";
                    ...
                    // Найдем первую пустую строку в столбце "Данные"
                    int nextRow = 1;
                    while (worksheet.Cells[nextRow, 2].Value != null)
                    {
                        nextRow++;
                    }
